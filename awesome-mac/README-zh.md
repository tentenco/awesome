...
* [截圖(Jietu)](http://jietu.qq.com/) - 截圖附帶強大的標注功能，騰訊作品。![Freeware][Freeware Icon]
...
* [Docker](https://www.docker.com/) - 開源的應用容器引擎。 [![Open-Source Software][OSS Icon]](https://github.com/github/hub) ![Freeware][Freeware Icon] [![Awesome List][awesome-list Icon]](https://github.com/veggiemonk/awesome-docker#readme)
...
* [LyricsX](https://github.com/ddddxxx/LyricsX) - 一款功能完備的歌詞工具。 [![Open-Source Software][OSS Icon]](https://github.com/ddddxxx/LyricsX) [![App Store][app-store Icon]](https://itunes.apple.com/cn/app/lyricsx/id1254743014?mt=12) ![Freeware][Freeware Icon]
...
* [百度輸入法](https://srf.baidu.com/input/mac.html) - 支持拼音五筆輸入。![Freeware][Freeware Icon]
* [落格輸入法](https://im.logcg.com/loginputmac) - 打破 Mac 雙拼多年來的窘境。
* [iAvro](https://www.omicronlab.com/iavro.html) - 孟加拉語輸入法。 [![Open-Source Software][OSS Icon]](https://github.com/torifat/iAvro) ![Freeware][Freeware Icon]
...
* [哈利路亞英文輸入法](https://github.com/dongyuwei/hallelujahIM) - 智能英文輸入法，具備自動補全，自動糾錯功能。 ![Freeware][Freeware Icon]

## 瀏覽器

*這裡放Mac的瀏覽器應用*

* [Brave](https://brave.com/) - 用 Brave 瀏覽更快更安全。 ![Freeware][Freeware Icon]
* [Chrome](http://www.google.cn/chrome/browser/) - Chrome 瀏覽器Google出品。![Freeware][Freeware Icon]
* [Firefox](http://www.firefox.com.cn/) - 迎接 Firefox Quantum。快，只為更好。火狐瀏覽器。![Freeware][Freeware Icon]
* [Safari](http://www.apple.com/cn/safari/) - Mac 預裝自帶瀏覽器。![Freeware][Freeware Icon] [![Awesome List][awesome-list Icon]](https://github.com/learn-anything/safari-extensions#readme)
* [Opera](http://www.opera.com/zh-cn) - Opera 瀏覽器。![Freeware][Freeware Icon]
* [QQ瀏覽器](http://browser.qq.com/mac/) - QQ 瀏覽器－騰訊出品。![Freeware][Freeware Icon]
* [Vivaldi](https://vivaldi.com/) - Opera 開發商出品新的瀏覽器。![Freeware][Freeware Icon]
* [Ōryōki](http://oryoki.io/) - 小的 web 瀏覽器。這是一個試驗性的項目，目前正在開發中![Freeware][Freeware Icon]
* [傲游雲瀏覽器](http://www.maxthon.cn/mac/) - 傲游雲瀏覽器。![Freeware][Freeware Icon]
...
* [Grammarly](https://app.grammarly.com/) - 修正英語語法及用語
* [iText](https://toolinbox.net/iText/) - 截圖識別文字、翻譯  [![App Store][app-store Icon]](https://itunes.apple.com/cn/app/id1314980676?mt=12)
* [iTranslate](http://www.itranslate.com/) - 支持全世界超過 80 種語言發音和輸出。![Freeware][Freeware Icon]
* [Ludwig](https://ludwig.guru) - 語言搜索引擎，可幫助您用英語寫得更好。
* [Translate Tab](http://translate-tab.com/) - 菜單欄翻譯外掛，封裝了Google翻譯，支持自動識別語言。

## 安全工具

* [BlockBlock](https://objective-see.com/products/blockblock.html) - 惡意軟體會自行安裝，以確保它在重新引導時自動重新執行。
* [Dylib Hijack Scanner](https://objective-see.com/products/dhs.html) - Dylib 劫機掃描儀或 DHS，是一個簡單的實用程序，將掃描您的電腦的應用程序是易受 dylib 劫持或被劫持。
* [Encrypto](https://macpaw.com/encrypto) - 免費加密工具，用於加密文件和文件夾
* [KextViewer](https://objective-see.com/products/kextviewr.html) - 查看所有在 OS 內核中載入的模塊。
* [KnockKnock](https://objective-see.com/products/knockknock.html) - 「誰在那？」 查看Mac上持久安裝的內容。
* [LinkLiar](https://github.com/halo/LinkLiar) - 可以幫助你哄騙 Wi-Fi 和乙太網介面的 MAC 地址。 [![Open-Source Software][OSS Icon]](https://github.com/halo/LinkLiar) ![Freeware][Freeware Icon]
* [LuLu](https://objective-see.com/products/lulu.html) - 免費的macOS防火牆，旨在阻止未經授權（傳出）的網路流量。 [![Open-Source Software][OSS Icon]](https://www.tinc-vpn.org/git/browse?p=tinc) ![Freeware][Freeware Icon]
* [OverSight](https://objective-see.com/products/oversight.html) - 監控 Mac 的麥克風和網路攝像頭，當內部麥克風被開通，或者當進程訪問攝像頭時提醒用戶。
* [RansomWhere?](https://objective-see.com/products/ransomwhere.html) - 通用 Ransomware 檢測。
* [TaskExplorer](https://objective-see.com/products/taskexplorer.html) - 使用 TaskExplorer 探索在 Mac 上運行的所有任務（進程）。
* [What's Your Sign?](https://objective-see.com/products/whatsyoursign.html) - 驗證文件的加密簽名可以推斷其來源或可信度。

## 科學上網

*假設你是個勤奮的同學，你總有一天會強烈需要它們，上帝保佑他們吧。*

* [Algo](https://github.com/trailofbits/algo) - 在雲中設置個人 IPSEC VPN。 [![Open-Source Software][OSS Icon]](https://github.com/trailofbits/algo)
* [ClashX](https://github.com/yichengchen/clashX) - 基於 clash 的一款支持規則過濾的科學上網工具。 [![Open-Source Software][OSS Icon]](https://github.com/yichengchen/clashX)![Freeware][Freeware Icon]
* [FreeVPN Plus](https://www.freevpn.pw/mac-vpn) - 永不過期 Mac 免費VPN。 ![Freeware][Freeware Icon]
* [Firefly 螢火蟲](https://github.com/yinghuocho/firefly-proxy) - 免費科學上網。
...
* [GTX加速器](http://www.jsqgtx.cc/DownLoad) - 每天簽到領取 500M 流量。![Freeware][Freeware Icon]
* [Lantern](https://getlantern.org) - 科學上網。[![Open-Source Software][OSS Icon]](https://github.com/getlantern/lantern) ![Freeware][Freeware Icon]
* [LoCoVPN](https://www.locovpn.co/mannul/) - 每天簽到可獲得 2 小時免費VPN加速。![Freeware][Freeware Icon]
* [SpechtLite](https://github.com/zhuhaow/SpechtLite) - 支持 Shadowsocks 及規則管理的高效率代理。[![Open-Source Software][OSS Icon]](https://github.com/shadowsocks) ![Freeware][Freeware Icon]
* [ShadowsocksX](http://shadowsocks.org/) - 一個快速的隧道代理，可以幫助你繞過防火牆。[![Open-Source Software][OSS Icon]](https://github.com/shadowsocks) ![Freeware][Freeware Icon]
* [ShadowsocksX-NG](https://github.com/qiuyuzhou/ShadowsocksX-NG) - 一款 ShadowsocksX 客戶端軟體。[![Open-Source Software][OSS Icon]](https://github.com/qiuyuzhou/ShadowsocksX-NG) ![Freeware][Freeware Icon]
* [Surge](https://nssurge.com/) - 科學上網。
* [Shimo](https://www.shimovpn.com/) - 連接大量 VPN 的應用
* [Tunnelbear](https://www.tunnelbear.com) - 簡單的私人 VPN。 ![Freeware][Freeware Icon]
* [Tunnelblick](https://tunnelblick.net/downloads.html) - OpenVPN 的免費軟體。![Freeware][Freeware Icon]
* [tinc](https://www.tinc-vpn.org) - VPN 軟體. [![Open-Source Software][OSS Icon]](https://www.tinc-vpn.org/git/browse?p=tinc) ![Freeware][Freeware Icon]
* [V2Ray](https://www.v2ray.com/) - 原生支持 Socks、HTTP、Shadowsocks、VMess 等協議。
* [V2rayU](https://github.com/yanue/V2rayU) - 一款 v2ray 客戶端軟體。[![Open-Source Software][OSS Icon]](https://github.com/yanue/V2rayU) ![Freeware][Freeware Icon]
* [二師兄VPN](http://www.2-vpn4.cc/home.action) - 提供無限流量、無限續期免費 VPN 賬號。![Freeware][Freeware Icon]
* [風馳VPN](http://fengchinet2.com/) - 無限流量、無限續期的免費 VPN 加速服務。![Freeware][Freeware Icon]


## 其它實用工具

* [12306ForMac](https://github.com/fancymax/12306ForMac) - Mac 版 12306 訂票/檢票助手。[![Open-Source Software][OSS Icon]](https://github.com/fancymax/12306ForMac) ![Freeware][Freeware Icon]
* [1440 Minutes Left Today](https://1440app.com/) - 在菜單欄中，直接記錄到一天結束還剩多少分鐘。![Freeware][Freeware Icon] [![App Store][app-store Icon]](https://apps.apple.com/cn/app/1440/id1483764819)
...
* [BitBar](https://getbitbar.com/) - 支持使用各種語言將訊息展示到Mac OS的菜單欄。[![Open-Source Software][OSS Icon]](https://github.com/matryer/bitbar) ![Freeware][Freeware Icon]
* [BetterZip 3](https://macitbetter.com/) - 壓縮解壓縮工具支持格式 ZIP、TAR、TGZ、TBZ、TXZ (new)、7-ZIP、RAR。![Freeware][Freeware Icon]
* [BetterTouchTool](https://boastr.net) - 代替默認的系統操作方式（組合鍵、修飾鍵、手勢等）。![Freeware][Freeware Icon]
* [CopyQ](https://hluk.github.io/CopyQ) - 高級功能剪貼板管理工具。 [![Open-Source Software][OSS Icon]](https://github.com/hluk/CopyQ) ![Freeware][Freeware Icon]
* [ControlPlane](http://www.controlplaneapp.com/) - 自定義 Mac 情景模式。某些場景讓 Mac 自動靜音或是自動打開 Mail 客戶端等等。[![Open-Source Software][OSS Icon]](https://github.com/dustinrue/ControlPlane) ![Freeware][Freeware Icon]
* [ClipMenu](http://www.clipmenu.com) - 一個剪貼板操作的管理器。[![Open-Source Software][OSS Icon]](https://github.com/naotaka/ClipMenu) ![Freeware][Freeware Icon]
* [Clipy](https://clipy-app.com/) - 基於 ClipMenu 繼續開發的強大的剪切板管理器。 [![Open-Source Software][OSS Icon]](https://github.com/Clipy/Clipy) ![Freeware][Freeware Icon]
* [CheatSheet](https://www.mediaatelier.com/CheatSheet/) - CheatSheet 是一款 Mac 上的非常實用的快速鍵快速提醒工具。 ![Freeware][Freeware Icon]
* [DaisyDisk](https://daisydiskapp.com/) - 磁碟空間使用掃描工具。
* [DNS Heaven](https://github.com/greenboxal/dns-heaven) - 可以令基於 glibc 的 macOS 應用直接使用原生棧來解析 DNS，主要適用於 VPN。 [![Open-Source Software][OSS Icon]](https://github.com/greenboxal/dns-heaven) ![Freeware][Freeware Icon]
* [eZip](http://ezip.awehunt.com) - 介面簡潔，功能完善，支持主流的多種壓縮格式。支持 Mojave 深色模式、QuickLook預覽、拖拽解壓。 ![Freeware][Freeware Icon]
* [f.lux](https://justgetflux.com/) - 自動調整您的電腦螢幕，以匹配亮度。![Freeware][Freeware Icon]
* [Hammerspoon](http://www.hammerspoon.org/) - 功能強大的自動化工具，Lua 腳本驅動，支持窗口管理。[![Open-Source Software][OSS Icon]](https://github.com/Hammerspoon/hammerspoon) ![Freeware][Freeware Icon]
* [HTTrack](http://www.httrack.com) - 可以下載整個網站和離線瀏覽。![Freeware][Freeware Icon]
* [HapticKey](https://github.com/niw/HapticKey/releases) - Touch Bar 觸覺回饋。 [![Open-Source Software][OSS Icon]](https://github.com/niw/HapticKey) ![Freeware][Freeware Icon]
* [HWSensors](https://sourceforge.net/projects/hwsensors) - 自帶FakeSMC的黑蘋果硬體狀態監控外掛。 [![Open-Source Software][OSS Icon]](https://bitbucket.org/kozlek/hwsensors/overview) ![Freeware][Freeware Icon]
* [Hungrymark](https://zhengying.github.io/hungrymark) - 非常有用的收藏夾應用，收藏文件，文件夾，網址，快速的通過狀態欄菜單訪問這些書籤。  [![App Store][app-store Icon]](https://apps.apple.com/cn/app/hungrymark/id1482778901?l=en&mt=12)
* [iStat pro](https://bjango.com/mac/istatmenus/) - 免費的 Mac OS 電腦硬體訊息檢測軟體。![Freeware][Freeware Icon]
...
* [Karabiner](https://pqrs.org/osx/karabiner/) - 一個強大的和穩定的 OS X 的鍵盤定製。[![Open-Source Software][OSS Icon]](https://github.com/tekezo/Karabiner) ![Freeware][Freeware Icon]
* [Keyboard Maestro](http://www.keyboardmaestro.com) - 根據鍵盤，菜單，位置，添加的設備等觸發器自動執行日常操作。
* [Keytty](http://keytty.com) - 讓你通過鍵盤使用滑鼠。
* [Keka](https://www.keka.io) - 一個免費的 macOS 文件解壓縮程序。 [![Open-Source Software][OSS Icon]](https://github.com/aonez/Keka) ![Freeware][Freeware Icon] [![App Store][app-store Icon]](https://itunes.apple.com/app/keka/id470158793)
* [Lungo](https://sindresorhus.com/lungo) - 防止Mac進入睡眠狀態。 [![App Store][app-store Icon]](https://apps.apple.com/cn/app/lungo/id1263070803)
* [Memo](http://memo-app.net/) - 給你的便箋加個密。![Freeware][Freeware Icon] [![App Store][app-store Icon]](https://itunes.apple.com/app/id1212409035)
* [Manta](https://manta.life/) - 靈活的發票桌面應用程序，漂亮和可定製模板。[![Open-Source Software][OSS Icon]](https://github.com/hql287/Manta) ![Freeware][Freeware Icon]
* [Mos](https://mos.caldis.me/) - 讓你的滑鼠滾輪絲滑如觸控板。[![Open-Source Software][OSS Icon]](https://github.com/Caldis/Mos) ![Freeware][Freeware Icon]
* [Mac Cache Cleaner](https://github.com/kaunteya/MacCacheCleaner) - 緩存清理工具 [![Open-Source Software][OSS Icon]](https://github.com/kaunteya/MacCacheCleaner) ![Freeware][Freeware Icon]
* [Numi](http://numi.io/) - 漂亮的計算器應用。![Freeware][Freeware Icon]
* [NoSleep](https://www.macupdate.com/app/mac/37991/nosleep) - 合上蓋子不休眠，可根據是否連接電源單獨設置。
* [openEmu](http://openemu.org/) - 模擬器，可以玩魂斗羅之類，輕鬆回到小時候。[![Open-Source Software][OSS Icon]](https://github.com/OpenEmu/OpenEmu) ![Freeware][Freeware Icon]
* [OmniDiskSweeper](https://www.omnigroup.com/more) - 磁碟空間使用掃描工具。 ![Freeware][Freeware Icon]
* [OmniPlan](https://www.omnigroup.com/omniplan/) - 項目管理軟體。
* [Paste](http://pasteapp.me) - 智能剪貼板歷史片段管理。 ![Freeware][Freeware Icon] [![App Store][app-store Icon]](https://itunes.apple.com/us/app/paste-clipboard-history-manager/id967805235)
* [PasteBot](https://tapbots.com/pastebot/) - 強大的剪貼板管理器。 [![App Store][app-store Icon]](https://itunes.apple.com/us/app/pastebot/id1179623856)
* [PDF Archiver](https://github.com/JulianKahnert/PDF-Archiver) - 一個用於標記和歸檔任務的好工具。[![Open-Source Software][OSS Icon]](https://github.com/JulianKahnert/PDF-Archiver) [![App Store][app-store Icon]](https://itunes.apple.com/app/pdf-archivar/id1352719750)
* [Qbserve](https://qotoqot.com/qbserve/) - 觀察你如何度過你的時間。
* [RescueTime](https://www.rescuetime.com/) - 個人分析服務，向您展示如何花時間和提供工具來幫助您提高工作效率。
* [Snap](http://indragie.com/snap) - 一款可以給 Dock 上的程序添加快速鍵的小工具。 ![Freeware][Freeware Icon] [![App Store][app-store Icon]](https://itunes.apple.com/cn/app/id418073146)
* [Streaker](https://github.com/jamieweavis/streaker) - GitHub貢獻和統計跟蹤菜單欄應用程序。 [![Open-Source Software][OSS Icon] ![Freeware][Freeware Icon]](https://github.com/jamieweavis/streaker)
* [The Unarchiver](https://theunarchiver.com/) - 解壓許多不同種類的歸檔壓縮文件。 [![Open-Source Software][OSS Icon]](https://bitbucket.org/kosovan/theunarchiver) ![Freeware][Freeware Icon]
* [Timing](https://timingapp.com/) - Mac 的自動時間和生產力跟蹤。
* [Ukelele](http://scripts.sil.org/ukelele) - Unicode 鍵盤布局編輯器。
...
* [xScope](http://xscopeapp.com/) - 測量、檢查和測試螢幕上的圖形和布局的工具。搜索你的蘋果和網路，快速打開應用程序。

### 剪貼板工具

* [ClipMenu](http://www.clipmenu.com) - 一個剪貼板操作的管理器。[![Open-Source Software][OSS Icon]](https://github.com/naotaka/ClipMenu) ![Freeware][Freeware Icon]
* [CopyQ](https://hluk.github.io/CopyQ) - 高級功能剪貼板管理工具。 [![Open-Source Software][OSS Icon]](https://github.com/hluk/CopyQ) ![Freeware][Freeware Icon]
* [iPaste](https://en.toolinbox.net/iPaste) - 輕巧高效的剪貼板工具。 ![Freeware][Freeware Icon] [![App Store][app-store Icon]](https://itunes.apple.com/app/id1056935452?ls=1&mt=12&at=1000lv4R&ct=iPaste_me)
* [Paste](http://pasteapp.me) - 智能剪貼板歷史片段管理。 ![Freeware][Freeware Icon] [![App Store][app-store Icon]](https://itunes.apple.com/cn/app/paste-clipboard-history-manager/id967805235)
* [PasteBot](https://tapbots.com/pastebot/) - 強大的剪貼板管理器。 [![App Store][app-store Icon]](https://itunes.apple.com/cn/app/pastebot/id1179623856)

### 菜單欄工具

* [BeardedSpice](https://github.com/beardedspice/beardedspice) - 允許您使用 Mac 鍵盤上的媒體鍵控制基於Web的媒體播放器（SoundCloud，YouTube 等）和一些本機應用程序。 [![Open-Source Software][OSS Icon]](https://github.com/beardedspice/beardedspice) ![Freeware][Freeware Icon]
* [Bartender](https://www.macbartender.com) - 組織或隱藏Mac上的菜單欄圖標。
* [BitBar](https://getbitbar.com/) - 支持使用各種語言將訊息展示到 Mac OS 的菜單欄。[![Open-Source Software][OSS Icon]](https://github.com/matryer/bitbar) ![Freeware][Freeware Icon]
* [iGlance](https://github.com/Moneypulation/iGlance) - 狀態欄的系統監視器。 [![Open-Source Software][OSS Icon]](https://github.com/Moneypulation/iGlance) [![Freeware][Freeware Icon]](https://github.com/Moneypulation/iGlance)
* [Itsycal](https://www.mowglii.com/itsycal/) - 一款簡潔實用的開源日曆工具。[![Open-Source Software][OSS Icon]](https://github.com/sfsam/itsycal) ![Freeware][Freeware Icon]
* [Vanilla](http://vanilla.matthewpalmer.net) - 隱藏系統菜單欄。 ![Freeware][Freeware Icon]

### 待辦事項工具

* [2Do](http://www.2doapp.com/) - 比較好的 TODO 應用程序。
* [Day-O 2](http://www.shauninman.com/archive/2016/10/20/day_o_2_mac_menu_bar_clock) - 菜單日曆更換內置日曆。![Freeware][Freeware Icon]
* [Fantastical](https://flexibits.com/fantastical) - 日曆應用程序，你將管理好生活。
* [Focus](https://masterbuilders.io) - 一個漂亮的番茄工作法為基礎的時間管理工具。 [![App Store][app-store Icon]](https://itunes.apple.com/cn/app/focus-productivity-timer/id777233759?mt=12)
* [Microsoft To-Do](https://todo.microsoft.com/) - 任務管理工具微軟出品。 ![Freeware][Freeware Icon] [![App Store][app-store Icon]](https://apps.apple.com/cn/app/microsoft-to-do/id1274495053?mt=12)
* [Nozbe](https://nozbe.com) - 適用於個人和團隊的強大GTD應用程序，支持每個Apple設備。[![App Store][app-store Icon]](https://itunes.apple.com/cn/app/nozbe-tasks-projects-team/id508957583?mt=12)
* [OmniFocus](https://www.omnigroup.com/omnifocus/) - 由 OmniGroups 製作的 Nice GTD 應用程序。
* [Taskade](https://www.taskade.com) - 即時協作編輯器，協作履歷任務管理器，大綱和筆記。
* [TaskPaper](https://www.taskpaper.com/) - 漂亮的純文本任務列表。
* [Things](https://culturedcode.com/things/) - 令人愉快且易於使用的任務管理器。
* [Todoist](https://todoist.com/mac) - 跨平台的任務管理器與移動應用程序。
* [Wunderlist](https://www.wunderlist.com/?ncr=1) - 奇妙清單跨平台的任務管理器與移動應用程序。![Freeware][Freeware Icon]
* [滴答清單](https://www.dida365.com/) - 輕便且強大的跨平台任務管理應用。![Freeware][Freeware Icon] [![App Store][app-store Icon]](https://itunes.apple.com/cn/app/id966085870)

### 系統相關工具

* [Amphetamine](https://itunes.apple.com/cn/app/amphetamine/id937984704) - 覆蓋您的節能設置並讓您的Mac保持清醒狀態。 ![Freeware][Freeware Icon] [![App Store][app-store Icon]](https://itunes.apple.com/cn/app/amphetamine/id937984704)
* [AppCleaner](http://freemacsoft.net/appcleaner/) - 一個小應用程序，讓你徹底卸載不需要的應用程序。![Freeware][Freeware Icon]
* [AppTrap](http://onnati.net/apptrap/) - 刪除APP的同時移除文件。 [![Open-Source Software][OSS Icon]](https://github.com/kvijayan/AppTrap) ![Freeware][Freeware Icon]
* [Cleaner for Xcode](https://github.com/waylybaye/XcodeCleaner) - Xcode 的清理工具，清理幾十G應該不是問題。[![Open-Source Software][OSS Icon]](https://github.com/waylybaye/XcodeCleaner) ![Freeware][Freeware Icon]
* [Coolant](https://coolantformac.com) - 這是能讓你知道什麼應用程序造成你 CPU100% 讓 Mac 電腦過熱電池耗盡的菜單應用程序。
* [coconutBattery](https://www.coconut-flavour.com/coconutbattery/) - 顯示Mac中有關電池的即時訊息。
* [DaisyDisk](https://daisydiskapp.com/) - 磁碟空間使用掃描工具。
* [FruitJuice](http://fruitjuiceapp.com) - 會讓你知道每天保持不插電的時間，以保持你的電池健康。[![App Store][app-store Icon]](https://itunes.apple.com/cn/app/fruitjuice/id671736912)
* [gfxCardStatus](https://gfx.io/) - 控制Mac獨立顯卡與整合顯卡之間的切換。![Freeware][Freeware Icon]
* [HandShaker](http://www.smartisan.com/apps/handshaker) -  Mac 電腦上也可以方便自如地管理您在 Android 手機中的內容。 ![Freeware][Freeware Icon]
* [HTML5 Player](http://zythum.sinaapp.com/youkuhtml5playerbookmark/) - Chrome 外掛解決中國視頻網站播放視頻電腦發熱的情況。
* [iStat Menus](https://bjango.com/mac/istatmenus/) - 菜單欄上的高級 Mac 系統監視器。
* [iStats](https://github.com/Chris911/iStats) - iStats 是一個可以讓你快速查看電腦 CPU 溫度，磁碟轉速和電池等訊息的命令行工具。[![Open-Source Software][OSS Icon] ![Freeware][Freeware Icon]](https://github.com/Chris911/iStats)
* [Juice](https://github.com/brianmichel/Juice) - 讓電池顯示更有趣 [![Open-Source Software][OSS Icon]](https://github.com/brianmichel/Juice) ![Freeware][Freeware Icon]
...
* [Monity](http://www.monityapp.com/) - 幫助用戶即時監控系統的一款非常漂亮的軟體。
* [Mounty](http://enjoygineering.com/mounty/) - NTFS 分區讀寫組件。![Freeware][Freeware Icon]
* [NitroShare](https://nitroshare.net/) - 跨平台網路文件傳輸應用程序。 [![Open-Source Software][OSS Icon]](https://github.com/nitroshare/nitroshare-desktop) ![Freeware][Freeware Icon]
* [OnyX](http://www.titanium.free.fr/) - 多功能實用工具來驗證磁碟和文件，運行清潔和系統維護任務，配置隱藏選項等。![Freeware][Freeware Icon]
* [OmniDiskSweeper](https://www.omnigroup.com/more) - 磁碟空間使用掃描工具。 ![Freeware][Freeware Icon]
* [Paragon NTFS](https://www.paragon-software.com/home/ntfs-mac/) - 在 Mac OS X 中完全讀寫、修改、訪問 Windows NTFS 硬碟、U 盤等外接設備的文件。
* [Porting Kit](http://portingkit.com/) - 在Mac中安裝Windows®遊戲。 ![Freeware][Freeware Icon]
* [SSH Tunnel](https://codinn.com/products/ssh-tunnel/) - 管理你的 SSH。
* [TG Pro](https://www.tunabellysoftware.com/tgpro/) - 溫度監控，風扇控制和硬體診斷，幫助您保持 Mac的 涼爽和健康。
* [Tuxera NTFS](http://www.tuxera.com/products/tuxera-ntfs-for-mac/) - Mac 上的 NTFS 文件系統驅動。
* [騰訊檸檬清理](https://lemon.qq.com/) - 一款免費的Mac系統清理軟體，替代原來的Mac電腦管家，騰訊出品。

### 窗口管理

* [Amethyst](http://ianyh.com/amethyst/) - 窗口管理器（自動保持窗口大小的窗口）。[![Open-Source Software][OSS Icon]](https://github.com/ianyh/Amethyst) ![Freeware][Freeware Icon]
* [BetterSnapTool](https://folivora.ai/bettersnaptool/) - 窗口管理工具，可通過快速鍵或窗口拖動快速實現分局。  [![App Store][app-store Icon]](https://itunes.apple.com/cn/app/dashlane-password-manager/id552383089)
* [Contexts](https://contexts.co/)- 提供比 Mac 原生 Dock 更強大功能尤其在你有多個螢幕的時候,它可以幫助你更快速切換。
* [Divvy](http://mizage.com/divvy/) - 憑借其驚人的 Divvy Grid 系統，窗口管理處於最佳狀態。
* [Moom](http://manytricks.com/moom/) - 多任務多窗口的軟體。
* [Magnet](http://magnet.crowdcafe.com/) - 一個窗口管理器，可以保持工作空間的組織。 [![App Store][app-store Icon]](https://itunes.apple.com/cn/app/id441258766)
* [ShiftIt](https://github.com/fikovnik/ShiftIt) - 窗口位置和大小管理軟體。 [![Open-Source Software][OSS Icon]](https://github.com/fikovnik/ShiftIt) ![Freeware][Freeware Icon]
* [Slate](https://github.com/jigish/slate) - 窗口管理器，可用 JavaScript 寫配置。[![Open-Source Software][OSS Icon]](https://github.com/jigish/slate) ![Freeware][Freeware Icon]
* [SizeUp](http://www.irradiatedsoftware.com/sizeup/) - 強大的，以鍵盤為中心的窗口管理。
* [Spectacle](https://www.spectacleapp.com) - 簡單的移動和調整大小的窗口，和可定製的鍵盤快速鍵。 [![Open-Source Software][OSS Icon]](https://github.com/eczarny/spectacle) ![Freeware][Freeware Icon]
* [Total Spaces](http://totalspaces.binaryage.com/) - 像 ubuntu 一樣提供窗口管理，為工作區創建熱鍵，使您可以輕鬆移動。

### 密碼管理

* [1password](https://1password.com/) - 跨平台帳號密碼管理軟體。
* [Authy](https://authy.com) - 雙因素身份驗證令牌管理器，可在您的設備上進行備份和同步。 ![Freeware][Freeware Icon]
* [Bitwarden](https://bitwarden.com) - 適用於Mac OS，iOS和瀏覽器的開源密碼管理工具。 [![Open-Source Software][OSS Icon]](https://github.com/bitwarden) ![Freeware][Freeware Icon]
* [Buttercup](https://buttercup.pw/) - 跨平台密碼管理器 ![Freeware][Freeware Icon] [![Open-Source Software][OSS Icon]](https://github.com/buttercup/buttercup-desktop)
* [Dashlane](https://www.dashlane.com) - 基於雲的密碼管理器，擁有屢獲殊榮的設計。 [![App Store][app-store Icon]](https://itunes.apple.com/cn/app/dashlane-password-manager/id552383089)
* [Enpass](https://www.enpass.io/) - 具有雲整合的跨平台密碼管理工具。 [![App Store][app-store Icon]](https://itunes.apple.com/cn/app/enpass-password-manager/id732710998?mt=12)
* [Keeweb](https://keeweb.info/) - 與 KeePass 兼容的免費跨平台密碼管理器。 [![Open-Source Software][OSS Icon]](https://github.com/keeweb/keeweb) ![Freeware][Freeware Icon]
* [LastPass](https://www.lastpass.com/) - 密碼管理器和安全的數字筆記。
* [MacPass](https://macpass.github.io/) - 密碼管理器。[![Open-Source Software][OSS Icon]](https://github.com/mstarke/MacPass) ![Freeware][Freeware Icon]
* [RememBear](https://www.remembear.com/) - 治愈系密碼管理工具。 ![Freeware][Freeware Icon]

### Finder

* [fman](https://fman.io) - 先進的雙窗口文件管理器，擁有很多特性。
* [ForkLift](http://binarynights.com/forklift/) - 先進的雙窗口文件管理器和文件傳輸客戶端。
* [Hazel](https://www.noodlesoft.com) - 設計精美的自動文件管理軟體。
...
* [Path Finder](http://www.cocoatech.com/pathfinder/) - 強大的 Finder 替代者，擁有很多特性。
* [Quicklook-Plugins](https://github.com/sindresorhus/quick-look-plugins) - Finder 快速預覽文件外掛。
* [QSpace](https://qspace.awehunt.com) - 一款簡潔高效的多視圖文件管理器。 [![App Store][app-store Icon]](https://apps.apple.com/cn/app/id1469774098)
* [TotalFinder](http://totalfinder.binaryage.com/) - 強大的 Finder 替代者，介面風格像 Chrome。
* [XtraFinder](https://www.trankynam.com/xtrafinder/) - 給 Finder 添加有用的新特性。![Freeware][Freeware Icon]



## 遠程協助

* [AnyDesk](https://anydesk.com) 是一款遠程控制跨多平台的程序。
* [RealVNC](https://www.realvnc.com) 是一款免費的遠程控制跨多平台的程序。 ![Freeware][Freeware Icon]
* [TeamViewer](https://www.teamviewer.com) - 遠程協助及在線協作和會議功能的軟體，商業軟體個人使用免費。![Freeware][Freeware Icon]
...
*使用 [Homebrew Cask](https://github.com/phinze/homebrew-cask) 將通過命令安裝即為簡單。開發人員使用的[Quick Look](http://en.wikipedia.org/wiki/Quick_Look)外掛列表。如果手動安裝，你可將下載的 `.qlgenerator` 文件移動到 `~/Library/QuickLook` 運行 `qlmanage -r`*

* [QuicklookStephen](https://github.com/whomwah/qlstephen) - 可以讓您查看沒有文件擴展名的純文本文件，如 README、INSTALL、Capfile、CHANGELOG...`brew cask install qlstephen`
...
* [Homebrew Cask](http://caskroom.github.io) - 基於[Homebrew](https://brew.sh/)擴展的，通過命令行安裝 Mac GUI 軟體的工具。[![Open-Source Software][OSS Icon]](https://github.com/caskroom/homebrew-cask) ![Freeware][Freeware Icon]
* [Homebrew](https://brew.sh/) - 體驗通過命令行安裝 Mac 軟體的工具(大部分是命令行工具)。[![Open-Source Software][OSS Icon]](https://github.com/Homebrew/brew/) ![Freeware][Freeware Icon]
* [MacUpdate Desktop](https://www.macupdate.com/) - 管理/更新/下載 App，跟蹤優惠訊息。
* [MacPorts](https://www.macports.org/) - 一個軟體包管理工具，可用於簡化 OS X 和 Darwin 操作系統內軟體的安裝。 ![Freeware][Freeware Icon] [![Open-Source Software][OSS Icon]](https://github.com/macports/)
* [Setapp](https://setapp.com) - MacPaw 推出的訂閱制付費 App 平台服務。

### 應用商店黑名單

*第三方應用市場APP黑名單，存在盜版軟體傳播和下載，拒絕盜版從我做起，歡迎大家監督它們。*

* ~~[迅雷Thunder Store](http://mac.xunlei.com/app/)~~ - 迅雷 Thunder for Mac 帶應用市場。
* ~~[Mac軟體寶箱](http://box.macx.cn/)~~ - Macx 推出軟體寶箱。
* ~~[MacHunter](http://www.machunter.net/)~~ - Mac 應用市場。
...
* Mac玩兒法：[http://www.waerfa.com](http://www.waerfa.com) ![Freeware][Freeware Icon]
* 騰訊檸檬精選：[https://lemon.qq.com/lab/](https://lemon.qq.com/lab/)

### 盜版軟體下載網站黑名單

*上面有大量的開源軟體或者免費軟體，拒絕盜版從我做起，下面被刪除的網站提供大量破解軟體下載，歡迎大家監督它們。*

* 玩轉蘋果：~~`http://www.ifunmac.com`~~
...
* MacSky蘋果軟體園：~~`http://www.macsky.net/`~~
* Softasm：~~`https://softasm.com/`~~
* Mac破解軟體：~~`https://www.macappstore.net/`~~
* 卡卡源：~~`http://www.kkroot.com/`~~
* 蘋果軟體園：~~`http://www.maczapp.com`~~
* 馬可菠蘿：~~`http://www.macbl.com/`~~
* 極致分享：~~`https://alltoshare.com/`~~
* 麥克社：~~`http://www.macshe.com/`~~
* 未來軟體園：~~`http://www.orsoon.com/`~~
* 騰牛網：~~`http://www.qqtn.com/mac/r_17_1.html`~~
* 未來軟體園：~~`http://www.orsoon.com/mac/`~~
* 威鋒網：~~`https://bbs.feng.com/forum.php?mod=forumdisplay&fid=19&page=`~~
