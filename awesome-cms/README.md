...
- 微軟天青
  - [Azure Functions](https://docs.microsoft.com/en-us/azure/azure-functions/) - 使您能夠按需運行代碼而無需顯式預配或管理基礎結構的無服務器計算服務。
...
- [Jamify 教程 — 使用 Gatsby 和 Ghost 發布快速博客](https://www.jamify.org)
